...
// NOTE: VITE_API_KEY is used for client-side Vite applications.
// Safety check added for import.meta.env
...
export const generateMedicalResponse = async (
  ...
  if (!apiKey) {
    return "Configuration Error: Gemini API Key is missing. Please check your environment variables (VITE_API_KEY).";
  }
