...
export const generateOpenAIResponse = async (
  ...
  const apiKey = import.meta.env && import.meta.env.VITE_OPENAI_API_KEY;

  if (!apiKey) {
    return "Configuration Error: OpenAI API Key is missing in environment variables (VITE_OPENAI_API_KEY).";
  }
